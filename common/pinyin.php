...
class PinYin
{
    ...
    /**
     * 将utf8编码的转换为拼音
     * @param $input string 中文字符串
     * @param $isfirst boolean 是否要获取中文拼音首字母
     * @return string
     */
    public static function utf8ToPinyin($input, $isfirst = false)
    {
        return self::to(self::utf8_to_gb2312($input), $isfirst);
    }
